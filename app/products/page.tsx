    ...
    <main className="min-h-screen flex flex-col bg-background">
      ...
      <div className="pt-24 pb-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12" dir={isRTL ? "rtl" : "ltr"}>
                ...
                <button
                  ...
                  className={`px-6 py-2 rounded-full font-medium transition-colors ${
                    selectedCategory === category.id
                      ? "bg-bdf-gold text-white"
                      : "bg-gold-50 dark:bg-bdf-brown/40 text-bdf-brown dark:text-gold-100 hover:bg-gold-100 dark:hover:bg-bdf-darkgold/60"
                  }`}
                >
                  {category.name}
                </button>
          ...
          {/* Call to Action */}
          <div className="mt-16 text-center bg-gradient-to-r from-gold-50 to-gold-100 dark:from-bdf-brown/60 dark:to-bdf-darkgold/60 rounded-2xl p-8">
            <h2 className="text-3xl font-playfair font-bold mb-4 text-bdf-gold dark:text-gold-100">
              {language === "fr" ? "Besoin de quantités importantes ?" : language === "en" ? "Need large quantities?" : "تحتاج كميات كبيرة؟"}
            </h2>
            <p className="text-lg text-foreground/80 dark:text-gold-100/80 mb-6 max-w-2xl mx-auto">
              {language === "fr"
            ...
            <Button
              size="lg"
              className="bg-bdf-gold hover:bg-bdf-darkgold text-white font-semibold px-8 py-3 rounded-full transition-all duration-200 transform hover:scale-105"
